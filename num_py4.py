...
print("A's shape=", a.shape) #Rows and columns
print("a=",a)
...
print("B's shape=", b.shape) #Rows and columns
print("b=",b)
...
print("c=", c)
print("C's dimension=",c.ndim) #Dimension
print("C's shape=",c.shape) #Rows and columns
print("C's no.of elements=",c.size) #Number of elements within the array
